...
class _QuizHomeState extends State<QuizHome> {
                      ...
                      itemBuilder: (BuildContext context, int index) => GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => QuizDetails(category: _getCategoryFromName(mListings[index].quizName)),
                            ),
                          );
                        },
  ...
  /// Maps quiz names to question categories for remote fetching.
  String _getCategoryFromName(String quizName) {
    ...
    if (lower.contains('communication')) return 'Biology'; // fallback
    if (lower.contains('investment')) return 'Biology'; // fallback
    return 'Biology';
  }
}
