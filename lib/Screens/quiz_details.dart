...
class QuizDetails extends StatefulWidget {
  ...
  /// Category name to pass to the quiz card screen for filtering.
  final String? category;

  const QuizDetails({super.key, this.category});
                ...
                const  SizedBox(
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return quizList(mList[index], index, category: widget.category);
                      }),
                ],
              ),
            ),
...
class quizList extends StatelessWidget {
  ...
  final String? category;
   ...
   quizList(this.model, int pos, {super.key, this.category});
        ...
        children: <Widget>[
         ...
         const SizedBox(
          ...
          quizButton(
              ...
              onPressed: () {
                // Navigate to quiz with category for remote question loading
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => QuizCards(category: category ?? 'Biology'),
                  ),
                );
              })
        ],
